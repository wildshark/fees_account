                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="bootstrap-modal">                                  
                                    ...
                                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModalCenter">New Group</button>
                                    <!-- Modal -->
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <form action="index.php" method="post">
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="row">
                                                                ...
                                                                <div class="col-sm-6 mt-2 mt-sm-0">
                                                                    <input type="text" name='leader' class="form-control" placeholder="Group Leader Name">
                                                                </div>
                                                            </div>
                                                            <br>
                                                            <div class="row">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <button type="submit" name="_submit" value="add-group" class="btn btn-primary">Save</button>
                                                    </div>
                                                </form>     
                                            </div>
                                        </div>
                                                ...
                                                if((!isset($res))||($res == false)){
                                                    ...
                                                    foreach($res as $r){
                                                        ...
                                                        echo"<tr>
                                                                ...
                                                                <td>{$r['mobile']}</td>
                                                                <td>{$r['status']}</td>
                                                                <td><a href='?_submit=delete&action=group&id={$r['group_id']}' class='btn btn-sm btn-square btn-danger btn-bin'>Delete</a></td>
                                                            </tr>";
