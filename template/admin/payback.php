                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Cash Pay Book</h4>
                            </div>
                            <div class="card-body">
                                <div class="bootstrap-modal">                                  
                                    <!-- Button trigger modal -->
                                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModalCenter">New PayBack</button>
                                    <!-- Modal -->
                                    <div class="modal fade" id="exampleModalCenter">
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title">Pay Back Cash From Client</h5>
                                                ...
                                                <form action="index.php" method="post">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <button type="submit" name="_submit" value="add-payback" class="btn btn-primary">Save</button>
                                                    </div>
                                                </form>     
                                            </div>
                                        </div>
